...
Brief overview of the open development mentiality.
...
Should be easily accessible, and visualised.
...
This could be the same interface as the presentation interface
(section~\ref{sub:Presentation interface}), or different.

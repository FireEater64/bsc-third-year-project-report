...
(Section~\ref{sub:messages}) to a broker - with a named destination (either a
...
developer.\footnote{Although, as discussed in Section~\ref{sub:messages}, this
...
Similar to Queues (Section~\ref{sub:queues}), topics are \glf{fifo} structures.

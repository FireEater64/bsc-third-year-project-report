...
\begin{description}
  ...
  Going on side by side, as proceedings; occurring together, as events or circumstances; (\textit{source: OED})
  \item[Parallelism] \hfill \\
  Concurrent or contemporary; existing in the same period of time. (\textit{source: OED})
\end{description}
